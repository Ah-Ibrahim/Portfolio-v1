	...
	return (
		<section className="bg-bg-secondary text-white section-padding pt-17 pb-6">
			...
			<div className="uppercase text-xl mt-6 text-center">
				I’ve spent the last couple of years crafting web interfaces,
				mastering the art of turning complexity into simplicity.
			</div>
			...
			<div className="uppercase text-xl mt-6 text-center">
				...
				developer, I turn ideas into experiences — shaping how people
				feel, move, and connect through the web.
			</div>
			...
			<div className="uppercase text-xl mt-6 text-center">
				I value clarity, precision, and emotion — both in code and in
				life. I believe in intentional design: every pixel and line
				should have purpose. I lean toward functional minimalism,
				crafting interfaces that feel effortless yet alive.
			</div>
