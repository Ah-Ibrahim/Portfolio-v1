  ...
  return (
    <section className="bg-bg-primary pt-23 section-padding md:pb-4">
      <div className="sm:max-md:px-4 flex flex-col isolate">
        ...
        <div className="text-[0.70rem] uppercase flex justify-between *:tracking-[1em] translate-x-2 md:w-1/3 md:ms-auto font-bold-condensed">
          <span>Based</span>
          <span>in</span>
          <span>Egypt</span>
        </div>
        <div className="flex mt-8 gap-x-1 md:gap-x-15 md:w-fit md:flex-row-reverse md:mx-auto md:bg-bg-accent md:pe-4 md:pb-4 -z-10">
      ...
      <a
        ...
        className="flex flex-col items-center mt-25x md:mt-20 md:items-start"
      >
        <div className="w-max">
